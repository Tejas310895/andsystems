...
<form id="insert_purchase_invoice" method="post" action="">
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <small class="d-none" id="dublicate_purchase_inc">
                    <h6 class="text-danger">Same invoice is already inserted</h6>
                </small>
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="purchase_inc_custom_duty" aria-describedby="" placeholder="Total Custom Duty Applied on Invoice with tax">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label>Any Extra Charges Paid</label>
                <input type="text" class="form-control" name="transport_charges" aria-describedby="" placeholder="Enter Extra Charges Paid">
            </div>
        </div>
    </div>
    ...
    <div class="form-group fieldGroup">
        <div class="input-group">
            ...
            <input type="text" name="purchase_inc_product_qty[]" id="purchase_inc_product_qty" class="form-control" placeholder="Enter Qty" required />
            <input type="text" name="purchase_inc_product_hsn_code[]" id="purchase_inc_product_hsn_code" class="form-control" placeholder="Enter HSN CODE" required />
            <input type="text" name="purchase_inc_product_unit_rate[]" id="purchase_inc_product_unit_rate" class="form-control" placeholder="Enter Unit Rate" required />
