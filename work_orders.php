        ...
        <div class="card-body">
            <table class='table table-striped' id="table1">
                ...
                <tbody>
                    ...
                    $get_work_orders = "select * from work_order_entry where work_order_status='active'";
                    $run_work_orders = mysqli_query($con,$get_work_orders);
                    while($row_work_orders = mysqli_fetch_array($run_work_orders)){
                    ?>
                    <tr>
                        <td><?php echo date('d-M-Y H:i A',strtotime($row_work_orders['work_order_created_at'])); ?></td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="delete.php?work_order_delete=<?php echo $row_work_orders['work_order_entry_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you?');">Delete</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
