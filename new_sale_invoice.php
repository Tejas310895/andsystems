        ...
        <div class="col-12 grid-margin px-0">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="sale_inc_no" id="Inc_num_id" value="" required />
                                    <small id="Inc_alert_lable" class="text-danger d-none">Invoice Number already Used</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group row">
                ...
                <div class="card mb-3">
                    ...
                    <div class="form-check my-1 mx-4">
                        ...
                        <label class="form-check-label text-white" for="exampleCheck1">
                            <h5><i class="fas fa-check"></i> if consignee details are same as Billed</h5>
                        </label>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="form-group fieldGroup">
                            ...
                            <div class="input-group">
                                ...
                                <label for=""></label>
                                <input type="text" name="raw_inc_desc[]" id="raw_product_qty" class="form-control" placeholder="Description" />
                    ...
                    <div class="card-body">
                        <div class="form-group fieldGroup1">
                            ...
                            <div class="input-group">
                                ...
                                <label for=""></label>
                                <input type="text" name="custom_inc_desc[]" id="raw_product_qty" class="form-control" placeholder="Description" />
            ...
            <div class="form-group fieldGroupCopy" style="display: none;">
                <div class="input-group">
                    ...
                    <input type="text" name="raw_inc_desc[]" id="raw_product_qty" class="form-control" placeholder="Description" required />
                    <input type="text" name="raw_hsn_code[]" id="raw_product_qty" class="form-control" placeholder="HSN CODE" required />
            ...
            <div class="form-group fieldGroupCopy1" style="display: none;">
                <div class="input-group">
                    ...
                    <input type="text" name="custom_inc_desc[]" id="raw_product_qty" class="form-control" placeholder="Description" required />
                    <input type="text" name="custom_hsn_code[]" id="raw_product_qty" class="form-control" placeholder="HSN CODE" required />
...
if (isset($_POST['invoice_entry'])) {
    ...
    if ($product_type === 'raw') {
        ...
        $raw_inc_descArr = $_POST['raw_inc_desc'];
        ...
        $custom_inc_descArr = $_POST['custom_inc_desc'];
                    ...
                    if (!empty($raw_product_idArr)) {
                        for ($i = 0; $i < count($raw_product_idArr); $i++) {
                            if (!empty($raw_product_idArr[$i])) {
                                ...
                                $raw_inc_desc = $raw_inc_descArr[$i];
                    ...
                    if (!empty($custom_product_idArr)) {
                        for ($i = 0; $i < count($custom_product_idArr); $i++) {
                            if (!empty($custom_product_idArr[$i])) {
                                ...
                                $custom_inc_desc = $custom_inc_descArr[$i];
