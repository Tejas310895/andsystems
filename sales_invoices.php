                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-link bg-transparent border-0 text-dark" data-bs-toggle="modal" data-bs-target="#sic<?php echo $row_sale_inc['sale_inc_no']; ?>">
                                    <?php echo $row_sale_inc['billed_title']; ?>
                                </button>

                                <!--scrolling content Modal -->
                                <div class="modal fade" id="sic<?php echo $row_sale_inc['sale_inc_no']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                            ...
                            <td>
                                <!-- Button trigger for scrolling content modal -->
                                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#sp<?php echo $sale_inc_no; ?>">
                                    View Here
                                </button>

                                <!--scrolling content Modal -->
                                <div class="modal fade" id="sp<?php echo $sale_inc_no; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <form class="form" action="./sendpdf/index.php" method="POST" enctype="multipart/form-data" id="myform">
                                            <div class="input-group">
                                                <input type="hidden" name="Mail_inc_no" value="<?php echo $sale_inc_entry_id; ?>" required>
                                                <input type="file" class="form-control" name="bill_image" aria-describedby="inputGroupFileAddon04" aria-label="Upload" required>
                                                <button class="btn btn-warning" type="submit" name="mail_sent">Mail</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                <!-- Button trigger modal -->
                                <!-- <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#billmail<?php //echo $sale_inc_entry_id; 
                                                                                                                                    ?>">
                                    Mail
                                </button> -->

                                <!-- Modal -->
                                <!-- <div class="modal fade" id="billmail<?php //echo $sale_inc_entry_id; 
                                                                            ?>" tabindex="-1" aria-labelledby="billmail<?php //echo $sale_inc_entry_id; 
                                                                                                                        ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Your Custom Image</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="sendpdf\index.php" method="POST" enctype="multipart/form-data">
                                                    <div class="mb-3">
                                                        <input type="hidden" name="Mail_inc_no" value="<?php //echo $sale_inc_entry_id; 
                                                                                                        ?>" required>
                                                        <input class="form-control mb-2" type="file" name="bill_image" required>
                                                        <button type="submit" name="submit" class="btn btn-primary pull-right">Send Mail</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
