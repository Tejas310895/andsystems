                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#pi<?php echo $purchase_inc_entry_id; ?>">
                                    View Here
                                </button>

                                <!--scrolling content Modal -->
                                <div class="modal fade" id="pi<?php echo $purchase_inc_entry_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                            ...
                            <td class="text-center">
                                ...
                                <a href="rev_purchase_invoice.php?purchase_inc=<?php echo $row_purchase_inc['purchase_inc_entry_id']; ?>" class="btn btn-warning" onclick="return confirm('Are you sure you?');">Revise</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
